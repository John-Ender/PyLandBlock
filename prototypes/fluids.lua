...
--new fluids
	...
	},
  {
    type = "fluid",
    name = "ethane",
    icon = "__pylandblock__/graphics/icons/ethane.png",
    icon_size = 64,
    default_temperature = 15,
    heat_capacity = "1KJ",
  ...
  },
  {
    type = "fluid",
    name = "dichloroethane",
    icon = "__pylandblock__/graphics/icons/1,2-dichloroethane.png",
    icon_size = 64,
    default_temperature = 15,
    heat_capacity = "1KJ",
    base_color = {r=0, g=0.34, b=0.6},
  ...
  },
  {
    ...
    icon = "__pylandblock__/graphics/icons/ethylenediamine.png",
    icon_size = 64,
    default_temperature = 15,
    heat_capacity = "1KJ",
    base_color = {r=0, g=0.34, b=0.6},
